...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://MovieTime:Pass0008@sushpp.9nslw.mongodb.net/?retryWrites=true&w=majority&appName=sushpp")
DATABASE_NAME = environ.get('DATABASE_NAME', "sushpp")
